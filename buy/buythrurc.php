...
$success = "";
if($_POST['buy_paymenttype'] == "rc")
{
	$requestdate = datetimelocal("Y-m-d"); 
	$requesttime = datetimelocal("H:i");
	$product = $_POST['buy_product'];
	$purchase = $_POST['buy_purchase'];
	$usage = $_POST['buy_usage'];
	$paymenttype = $_POST['buy_paymenttype'];
      ...
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="550" rowspan="3" valign="top" class="pagebody"><table width="100%" border="0" cellpadding="2" cellspacing="0">
              <tr>
                <td width="100%" class="pagebodyheading"><strong>Buy Relyon Products/Services | Step 2</strong></td>
              </tr>
              <tr>
                <td valign="top"><table width="100%" border="0" cellpadding="2" cellspacing="0">
                    ...
                    <tr>
                      <td><form action="" method="post" name="buy_currency" id="buy_currency" onsubmit="return false;"><table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
                          <tr>
                            <td width="40%" class="buyonlinebox">
                                <div>
                                  <p align="left"><span style="font-size:16px; color:#006699; font-weight:bold">Provide your Relyon Currency Number</span></p>
                                  <p>
                                    <strong>PIN No: 
                                    <label>
                                    <input name="buy_currencyno" type="text" class="formfields" id="buy_currencyno" size="50" maxlength="14" />
                                    </label>
                                  </strong></p>
                                  <p>
                                    <input type="hidden" name="buy_product_cur" id="buy_product_cur" value="<? echo($product); ?>" />
                                    <input type="hidden" name="buy_usage_cur" id="buy_usage_cur" value="<? echo($usage); ?>" />
                                    <input type="hidden" name="buy_purchase_cur" id="buy_purchase_cur" value="<? echo($purchase); ?>" />
                                  </p>
                                </div>                              </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td><div align="right">
                              <input name="buy_finish" type="button" class="formbutton" style="cursor:hand" value="Finish Purchase" alt="Click here to Proceed" onclick="buycurrencysubmit();" />
                            </div></td>
                          </tr>
                        </table>
                      </form></td>
