...
if(isset($_POST["businessname"],$_POST["contactperson"],$_POST["address"],$_POST["district"],$_POST["state"],$_POST["pincode"],$_POST["phone"],$_POST["emailid"],$_POST["dealerid"],$_POST["amount"]) == false || ($referhost <> 'rashmi' && $referhost <> 'imax.relyonsoft.com' && $referhost <> 'www.imax.relyonsoft.com') || checkemailaddress($_POST["emailid"]) == false)
{
	...
	$orderid = ""; //Optional
	$responseurl = "http://userlogin.relyonsoft.com/paydealerlogin/complete.php"; //Should not exceed 80 Chars
