...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
  <tr>
    <td width="100%" class="pagebodyheading"><strong>Payment for Saral PayPack - Updation / AMC</strong></td>
    </tr>
  <tr class="content">
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td valign="top">
	<form action="http://userlogin.relyonsoft.com/payspp/pay.php" method="post" name="spppayment" id="spppayment" onsubmit="return false;">
	<table width="100%" border="0" cellpadding="2" cellspacing="0">
      <tr>
        <td width="90">&nbsp;</td>
...
function validatecode()
{
	...
	else if(inventorycode.value > 1 && inventorycode.value < 40000)
	{
		document.getElementById('spppayment').submit();
	}
	else
	{
		alert("Code out of range. Please enter the right code.");
		inventorycode.focus();
	}
}
</script></td>
