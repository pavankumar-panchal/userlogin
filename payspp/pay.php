...
$query = "select * from update09_customers where inventorycode = '".$inventorycode."' AND requestpayment = 'Y' AND paymentstatus = 'UNPAID'";
...
$orderid = ""; //Optional
$responseurl = "http://userlogin.relyonsoft.com/payspp/complete.php"; //Should not exceed 80 Chars
