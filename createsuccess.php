        ...
        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td colspan="3" style="padding-right:10px">
              <div align="right"><a href="http://userlogin.relyonsoft.com">Home</a></div>
            </td>
          </tr>
          ...
          <tr>
            <td width="550" class="pagebody">
              <table width="100%" border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                  <td>Your account password has been sent over email to
                    <?php echo ($confirmemailid); ?>.
                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>Go through the email and login to your account through <a
                      href="http://userlogin.relyonsoft.com">http://userlogin.relyonsoft.com</a>. In case of any
                    problems, let us know at <a href="mailto:subscriptions@relyonsoft.com">support@relyonsoft.com</a>.
                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
