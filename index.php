...
if (isset($_POST['login'])) {
  ...
  if ($errormessage == "") {
    ...
    if ($errormessage == "") {
      ...
      setcookie(validemailid, $email, time() + 3600, "/");
      //Start login Session
      session_start();
  ...
  <table width="771" border="0" cellpadding="0" cellspacing="0" align="center">
            ...
            <td width="550" class="pagebody">
              <form method="post" action="index.php">
                <table width="100%" border="0" cellpadding="2" cellspacing="0">
                  <tr>
                    <td colspan="3" class="pagebodyheading">
                      <font size="-1"><strong>Relyon Subscribed Services</strong></font>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="3" valign="top">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="159">
                            <div align="center"><img src="images/userlogin-home-welcome.jpg"
                                alt="Register for free account" width="105" height="105" border="0" /></div>
                          </td>
                          <td width="373" valign="middle">
                            <div align="justify">Registering as a member, you will have access to Relyon Subscribed
                              Services (which includes Newsletters, Product Downloads and Much More) as well as all the
                              resources available to Relyonsoft.com members.</div>
                          </td>
                        </tr>
                      </table>
                    </td>
                  ...
                  <tr>
                    <td colspan="3" class="pagebodyheading">
                      <font size="-1"><strong>Login to your Relyon Account - OR - Signup for a Free Account </strong>
                      </font>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="3"><noscript>
                        <font color="#FF0000">This page requires JavaScript to function. Please enable it in your
                          browser and reopen the page.</font>
                      </noscript>
                      &nbsp;</td>
                  </tr>
                  <?php
    ...
    <td bgcolor="#FFFFCC" style="border: dashed 1px #999999" colspan="3"><div align="center"><font color="#FF0000">' . $errormessage . '</font></div></td>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><input name="lgnemail" type="text" class="formfields" id="lgnemail" size="30"
                        maxlength="50"
                        alt="Enter the email ID registered with Relyon Soft.com. If new User, click on Signup link below.">
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td width="48%"><input name="lgnpassword" type="password" class="formfields" id="lgnpassword"
                        size="30" maxlength="15" />
                      <input name="link" type="hidden" id="link" value="<?php if ($_REQUEST['link'] <> '')
                        echo ($_REQUEST['link']);
                      else
                        echo ("./home/index.php"); ?>" />
                    </td>
                  ...
                  <tr>
                    <td colspan="3" <?php if ($errormessage <> "")
                      echo ('class="pagebodyheading"'); ?>>
                      <div align="center"><strong><a href="signup.php">New Users - Click Here to Register for
                            Free</a></strong> </div>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="3">
                      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                        <TR vAlign=top>
                          <TD noWrap>&nbsp;</TD>
                          <TD>
                            <div align="right">[<a href="rtrpassword.php">Forgot Password?</a>] </div>
                          </TD>
                        </TR>
                      </TABLE>
                    </td>
            ...
            <td width="218" valign="top"
              ...
              <?php include("./inc/incmemberbenifits.php"); ?>
            </td>
          </tr>
        </table>
        <div>&nbsp;</div>
