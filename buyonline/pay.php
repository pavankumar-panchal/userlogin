...
$orderid = ""; //Optional
$responseurl = "http://userlogin.relyonsoft.com/buyonline/complete.php"; //Should not exceed 80 Chars
...
//Assign Product Name and Amount
$request = $_REQUEST['prd'];
switch($request)
{
	case "tdsp":
		$productname = "SaralTDS Professional";
		$amount = '2600.00';
		break;
	case "tdsc":
		$productname = "SaralTDS Corporate";
		$amount = '4550.00';
		break;
	case "tdsi":
		$productname = "SaralTDS Institutional";
		$amount = '8450.00';
		break;
	case "sit":
