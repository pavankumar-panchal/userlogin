...
if($ResponseCode == 0)
{
	...
	$query = "update com_clientdet set PAYMENTSTATUS = 'PAID' where CLIENTID = '".$transaction['recordreference']."'";
	$result = runwdodbquery($query);

	$fromname = "Relyon";
	$fromemail = "emails@relyonsoft.com";
	$toarray = array('Vijay' => 'vijaykumar@relyonsoft.com');
	$bccarray = array('Bigmail' => 'bigmail@relyonsoft.com', 'Relyonimax' => 'relyonimax@gmail.com');
	require_once("../functions/RSLMAIL_MAIL.php");
	$msg = "One Payment has been made just now.";
	$subject = "Saral eFile | Payment Successfull";
