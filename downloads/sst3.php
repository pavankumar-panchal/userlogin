...
$productname = "Saral eST3";
$product ='Saral eST3';
main_product($product);
/*$version = "7.05";
$releasedate = "05 July 2012";
$filesize = "52.40 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saralest3/setupex.exe";*/
$productrefid = "27"; //Do not edit this value
...
?>
  ...
  <tr>
    <td bgcolor="#E6EEF7" style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications5">
        <tr>
          <td colspan="3"><strong>Prerequisites to install Saral ST3</strong></td>
        </tr>
        <tr>
