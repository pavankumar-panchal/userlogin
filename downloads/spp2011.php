...
$productname = "Saral PayPack 2011";
$version = "5.06";
$releasedate = "14 October 2011";
$filesize = "256.79 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/setupex-2011.exe";
$productrefid = "1";
...
?>
  ...
  <tr>
    <td style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications3">
      <tr>
        <td colspan="3"><strong>Upgrade from Version 5.01:</strong></td>
      </tr>
      <tr>
        <td width="33%">Version</td>
        <td width="30%"><strong><font color="#FF3300"> 5.06</font></strong></td>
        <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack5p06.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
      </tr>
      <tr>
        <td>Release Dated</td>
