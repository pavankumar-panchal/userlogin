...
<tr>
    <td bgcolor="#D2E1F0" style="border:solid 1px #D2E1F0"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications2">
        ...
        <tr>
          ...
          <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saraltds.inst/stds-dotinst-1605-to-1700.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" kasperskylab_antibanner="on"></a></td>
        </tr>
        <tr>
          <td>Release Dated</td>
          <td> 02 Jan 2017 </td>
  ...
  <tr>
    <td bgcolor="#D2E1F0" style="border:solid 0px #999999">
        ...
        <tr bgcolor="#ECF2F9">
          ...
          <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saraltds.inst/hf-tds-dotinst-1700-1.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" kasperskylab_antibanner="on"></a></td>
        </tr>
        <tr bgcolor="#ECF2F9">
          <td>Release Dated</td>
          <td>20 Jan 2017</td>
