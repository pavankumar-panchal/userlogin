...
$productname = "Saral PayPack 2010";
$version = "4.00 Build 1";
$releasedate = "19 April 2010";
$filesize = "223.06 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/setupex.exe";
$productrefid = "1";
//Assign Values to Content- Saralpaypack 2009
$productnameold = "Saral PayPack 2009";
$versionold = "3.69 Build 9";
$releasedateold = "16 April 2010";
$filesizeold = "222.96 MB";
$downloadlinkold = "http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/setupex2009.exe";
$productrefidold = "1";
...
?>
      <tr>
        <td width="33%"><font size="-1"><? echo($productnameold);?></font></td>
        <td width="30%">Version <? echo($versionold);?></td>
      ...
      <tr>
        <td>Release Dated</td>
        <td><? echo($releasedateold);?></td>
      </tr>
      <tr>
        <td>Size</td>
        <td colspan="2"><? echo($filesizeold);?></td>
      </tr>
      <tr>
        <td>License</td>
  ...
  <tr>
    <td style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications2">
      ...
      <tr>
        ...
        <td width="30%"><strong><font color="#FF3300">Build 9</font></strong></td>
        <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack2009_Build9.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
      </tr>
      <tr>
        <td>Release Dated</td>
        <td>16 April 2010</td>
      ...
      <tr>
        <td>Applicable to </td>
        <td colspan="2">Version 3.69</td>
      </tr>
    </table></td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
    <td valign="top" style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications6">
        <tr>
          <td colspan="3"><strong>Product Download:</strong></td>
        </tr>
        <?  
...
?>
        <tr>
          ...
          <td width="37%" rowspan="2"><form action="" method="post" name="download" id="download2">
              <input type="hidden" value="download" name="download2"  />
              <input name="download2" type="image" src="../images/downloadbutton.gif" style="cursor:hand" alt="Click here to download"/>
          </form></td>
        </tr>
        <tr>
          <td>Release Dated</td>
   ...
   <tr><td>&nbsp;</td></tr>
   <tr>
     <td style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications7">
         <tr>
           <td colspan="3"><strong>Product Upgrade:</strong></td>
         </tr>
         <tr>
           <td width="33%">Version</td>
           <td width="30%"><strong><font color="#FF3300">Build 1</font></strong></td>
           <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack2010_Upgrade.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
         </tr>
         <tr>
           <td>Release Dated</td>
           <td>19 April 2010</td>
