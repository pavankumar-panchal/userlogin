...
$productname = "Saral eSign";
$version = "2.00";
$releasedate = "31 JULY 2015";
$filesize = "39.6 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saralesign/setupex.exe";
$productrefid = "24";
...
?>
      ...
      <tr>
        <td valign="top">Works for</td>
        <td colspan="2">
          <ol>
            <li> Saral TDS (above Version 9.00)</li>
            <li>Saral PayPack (above Version 3.60)</li>
          </ol></td>
      </tr>
      <tr>
        <td>License</td>
...
?>
  ...
  <tr>
    <td bgcolor="#D2E1F0" style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications5">
        <tr>
          <td colspan="3"><strong>Prerequisites to install Saral eSign</strong></td>
        </tr>
        <tr>
        ...
        <tr>
          <td valign="top">Adobe Acrobat Reader</td>
          <td colspan="2"><div align="center"><a href="http://get.adobe.com/reader/">Download</a></div></td>
        </tr>
    </table></td>
  </tr>
  <tr>
