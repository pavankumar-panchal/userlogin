...
$productname = "Saral TDS Plus";
$product ='Saral TDS - Plus';
main_product($product);
/*$version = "12.04";
$releasedate = "01 august 2012";
$filesize = "74.80 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saraltdsinst/setupex.exe";*/
$productrefid = "30";
...
?>
  <tr>
    ...
    <td style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications4">
      <tr>
        <td colspan="3"><strong>Port Data To Saral IncomeTax:</strong></td>
      </tr>
      <tr>
        <td width="33%">Version</td>
        <td width="30%">8.00</td>
        <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/support/setupex.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
      </tr>
      <tr>
        <td>Release Dated</td>
        <td>10 june  2010</td>
      ...
      <tr>
        ...
        <td colspan="2">  Puts the data from Saral TDS Corproate/Institutional software to Saral IncomeTax software automatically for 2010-11 AY.</td>
      </tr>
    </table></td>
  </tr>
  <tr>
