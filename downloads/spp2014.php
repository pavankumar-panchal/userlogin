...
$productname = "Saral PayPack 2014";
$version = "8.00";
$releasedate = "11 January 2014";
$filesize = "289948 KB";
...
?>
  ...
  <tr>
    <td style="border:solid 1px #999999" bgcolor="#D2E1F0"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications3">
      ...
      <tr>
        ...
        <td width="30%"><strong><font color="#FF3300"> 8.04</font></strong></td>
        <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack8p04.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
      </tr>
      <tr>
        <td>Release Dated</td>
        <td>30 Sep 2014</td>
  ...
  <tr>
    <td bgcolor="#D2E1F0" style="border:solid 1px #D2E1F0"><table width="100%" cellspacing="0" cellpadding="2" border="0" id="Specifications2">
        ...
        <tr>
          <td width="33%">Version</td>
          <td width="30%"><strong><font color="#FF3300"> 8.02 </font></strong></td>
          <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack8p02.exe"><img width="38" height="39" border="0" alt="Upgrade" src="../images/downloadbutton.gif"></a></td>
        </tr>
        <tr>
          <td>Release Dated</td>
          <td> 24 Jul 2014 </td>
  ...
  <tr>
    <td bgcolor="#D2E1F0" style="border:solid 0px #999999">
        ...
        <tr bgcolor="#ECF2F9">
          ...
          <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack8p02Fix1.exe"><img width="38" height="39" border="0" alt="Upgrade" src="../images/downloadbutton.gif"></a></td>
        </tr>
        <tr bgcolor="#ECF2F9">
          <td>Release Dated</td>
          <td>13 Aug 2014</td>
  ...
  <tr>
    <td style="border:solid 1px #999999" bgcolor="#D2E1F0"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications3">
      ...
      <tr>
        <td width="33%">Version</td>
        <td width="30%"><strong><font color="#FF3300"> 8.00</font></strong></td>
        <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack_SP_v7p0_to_v8p0.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
      </tr>
      <tr>
        <td>Release Dated</td>
        <td>10 Jan 2014</td>
