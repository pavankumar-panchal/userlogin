...
$productname = "Saral Communicator";
$version = "1.03";
$releasedate = "14 September 2010";
$filesize = "22.54 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saralcommunicator/setupex.exe";
$productrefid = "7";
...
?>
      <tr>
        ...
        <td width="37%" rowspan="2"><form action="" method="post" name="download" id="download"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralcommunicator/setupex.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a>
        </form>
        </td>
      </tr>
      <tr>
  ...
  <tr>
    <td style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications2">
      ...
      <tr>
        ...
        <td width="30%">1.03</td>
        <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralcommunicator/sc-100-to-103.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
      </tr>
      <tr>
        <td>Release Dated</td>
      ...
      <tr>
        <td>Applicable to </td>
        <td colspan="2">Versions above 1.00</td>
      </tr>
    </table></td>
  </tr>
  <tr>
