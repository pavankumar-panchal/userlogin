...
$productname = "Saral Accounts";
$product ='Saral Accounts';
main_product($productname);
/*$version = "6.02";
$releasedate = "29 February 2012";
$filesize = "162 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/sai/setupex.exe";*/
$productrefid = "22"; //Do not edit this value
...
?>
  ...
  <tr>
    <td bgcolor="#E6EEF7" style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications5">
        <tr>
          <td colspan="3"><strong>Prerequisites to install Saral Accounts</strong></td>
        </tr>
        <tr>
