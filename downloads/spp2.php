...
$productname = "Saral PayPack";
$version = "3.51";
$releasedate = "29 May 2008";
$filesize = "75.10 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/setup.zip";
$productrefid = "1";

$message="";
if(isset($_REQUEST['download']))
{
	include("../inc/downloadmis2.php"); 
}
...
?>
  ...
  <tr>
    <td style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications2">
      <tr>
        <td width="63%"><strong>Product Upgrade:</strong></td>
      </tr>
      <tr>
        <td>To upgrade existing version, <a href="http://www.saralpaypack.com/customers/upgrade.php" target="_blank">click here</a>.</td>
      </tr>
    </table></td>
  </tr>
  <tr>
