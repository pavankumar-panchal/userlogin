...
$filesize = "17.83 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/ivyoffice/setupex.exe";
$productrefid = "20";
$message="";
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top">
	<table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications">
<?  
if($message <> "")
echo('<tr>
