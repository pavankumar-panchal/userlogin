...
$filesize = "12.1 MB";
$downloadlink = "thankyou.php";*/
$productrefid = "26"; //Do not edit this value
...
?>
  ...
  <!--<tr>
    <td valign="top" style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications">
        <tr>
          <td colspan="3"><strong>Thank you for visiting:</strong></td>
        </tr>&nbsp;-->
        <?  
if($message <> "")
echo('<tr>
...
?>
<!--<tr>
          <td width="100%"><font size="-1">For more Information regarding products, Kindly contact at 1860-425-5570</font></td>
        </tr>    </table></td>
  </tr>
--><?php
product($product);
