...
$productname = "SaralVAT XML";
$version = "4.00";
$releasedate = "08 February 2010";
$filesize = "6.714 MB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saralvatxml/setupex.exe";
$productrefid = "19";
...
<td width="550" rowspan="3" valign="top" class="pagebody"><table width="100%" border="0" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top" style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications">
      <tr>
        <td colspan="3"><strong>Product Download: <font color="#FF6600">[Note that, this is only for  Value Added Tax of KARNATAKA]</font></strong></td>
      </tr>
      <?  
if($message <> "")
echo('<tr>
...
?>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications2">
      <tr>
      ...
      <tr>
        ...
        <td width="30%">4.00</td>
        <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralvatxml/svx-300-to-400.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
      </tr>
      <tr>
        <td>Release Dated</td>
        <td>3 March 2011</td>
      ...
      <tr>
        <td>Applicable to </td>
        <td colspan="2">2.00 and above</td>
      </tr>
    </table></td>
  </tr>
  <tr>
