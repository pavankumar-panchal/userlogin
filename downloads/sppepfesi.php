...
$productname = "Saral ePFESI";
$product ='Saral ePFESI';

// $version = "8.00";
// $releasedate = "26 March 2018";
// $filesize = "138 MB";
// $downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saralepfesi/setupex.exe";
  ...
  <!--  <tr>
    <td bgcolor="#D2E1F0" style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications3">
      ...
      <tr>
        ...
        <td width="30%"><strong>8.00</strong></td>
        <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralepfesi/epfesi-7000-to-8000.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
      </tr>
      <tr>
        <td>Release Dated</td>
        <td>26 March 2018</td>
...
<tr>
  ...
  <tr>
    <td bgcolor="#D2E1F0" style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications5">
        <tr>
          <td colspan="3"><strong>Prerequisites to install Saral ePFESI</strong></td>
        </tr>
        <tr>
