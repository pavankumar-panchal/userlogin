...
$productname = "Saral PayPack 2017";
...
<a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/setupex.exe">
...
<tr>
    <td bgcolor="#D2E1F0" style="border:solid 1px #D2E1F0"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications2">
        ...
        <tr>
          <td width="33%">Version</td>
          <td width="30%"><strong><font color="#FF3300"> 11.02 </font></strong></td>
          <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack_v11p0_To_11p02_ServicePack.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" kasperskylab_antibanner="on"></a></td>
        </tr>
        <tr>
          <td>Release Dated</td>
          <td> 20 June 2017 </td>
    ...
    <td bgcolor="#D2E1F0" style="border:solid 0px #999999">
        ...
        <tr bgcolor="#ECF2F9">
          ...
          <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack_v11p01_Fix1.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" ></a></td>
        </tr>
        <tr bgcolor="#ECF2F9">
          <td>Release Dated</td>
          <td>03 May 2017</td>
  ...
  <tr>
    <td class="pagebodyheading"><strong><a href="spp2016.php">Click here to download Saral PayPack 2016</a></strong></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
