...
$productname = "Saral PayPack 2016";
$version = "10.00";
$releasedate = "19 Jan 2016";
$filesize = "38000 KB";
$downloadlink = "http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack_v10p0_To_11p0.exe";
$productrefid = "1";
...
?>
        <tr>
          ...
          <td width="37%" rowspan="2">
          	<a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/setupex_1000.exe">
            	<img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0">
            </a>
          </td>
        </tr>
        <tr>
...
<tr>
  <td bgcolor="#D2E1F0" style="border:solid 1px #999999"><table width="100%" border="0" cellpadding="2" cellspacing="0" id="Specifications3">
      ...
      <tr>
        ...
        <td width="30%"><strong>10.03</strong></td>
        <td width="37%" rowspan="2"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack_SP_10p02_To_10p03.exe"><img src="../images/downloadbutton.gif" alt="Upgrade" width="38" height="39" border="0" /></a></td>
      </tr>
      <tr>
        <td>Release Dated</td>
