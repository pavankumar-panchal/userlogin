...
if($_POST['createuser'] == "Create User")
	...
	else
	{
		...
		$subject = "Your Relyonsoft.com subscription account has been activated.";
		$fromname = "Relyon";
		$fromemail =  "imax@relyon.co.in";
		$msg = file_get_contents("./inc/mail-signup-user.htm");
		$toarray[$usrname] = $email;
		//$toarray[$usrname] = 'meghana.b@relyonsoft.com';
		//$toarray[$usrname] = 'rashmi.hk@relyonsoft.com';
		$array = array();
		$array[] = "##NAME##%^%".$usrname;
		$array[] = "##EMAIL##%^%".$email;
		...
		$array[] = "##CREATEDONDATE##%^%".$createdondate;
